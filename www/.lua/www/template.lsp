...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
      <div class="container">
        <a class="navbar-brand" href="https://realtimelogic.com/">
          <img style="max-width:250px" src="https://realtimelogic.com/GZ/images/icons/RealTimeLogicInv.svg" alt="DNS Service"/>
        </a>
