...
<?lsp end ?>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="https://realtimelogic.com/services/SharkTrust/" class="brand-link">
      <img src="/dist/img/SharkTrustLogo.png" alt="SharkTrust Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
